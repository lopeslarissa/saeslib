...
def key_expansion(key):
    """
    Expande a chave de entrada em uma lista de palavras, Para isso faz um XOR bit a bit entre a palavra e a palavra
    anterior. Porém, se o índice da palavra for um múltiplo de 2 são realizadas funções adicionais.
